    ...
    <header className="flex h-14 items-center justify-between border-b border-[#1e1e2a] bg-bg-card px-4">
      ...
      <div className="flex flex-1 items-center">
        ...
        >
          ...
          />
          <kbd className="hidden rounded border border-[#1e1e2a] bg-bg-card px-1.5 py-0.5 text-[10px] text-text-tertiary sm:inline">
            Ctrl+K
          </kbd>
        </div>
      </div>
      ...
      <div className="flex items-center gap-3 ml-4">
        {/* Price list selector */}
        <button className="flex items-center gap-1.5 rounded-button border border-[#1e1e2a] bg-bg-primary px-3 py-1.5 text-xs text-text-secondary hover:border-[#2a2a3a] hover:text-text-primary transition-colors">
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-2 rounded-button px-2 py-1.5 text-text-secondary hover:bg-[#1a1a22] hover:text-text-primary transition-colors"
          >
          ...
          {userMenuOpen && (
            <>
              ...
              />
              <div className="absolute right-0 top-full z-50 mt-1 w-48 rounded-card border border-[#1e1e2a] bg-bg-card py-1 shadow-lg">
                <div className="border-b border-[#1e1e2a] px-3 py-2">
                  <p className="text-sm font-medium text-text-primary">Danish</p>
                  <p className="text-xs text-text-tertiary">danish@nexusglobal...</p>
                </div>
                <button className="flex w-full items-center gap-2 px-3 py-2 text-sm text-text-secondary hover:bg-[#1a1a22] hover:text-text-primary">
