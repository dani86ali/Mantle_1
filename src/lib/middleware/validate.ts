...
export const intakeFormSchema = z.object({
  ...
  vendor: z.enum(["cisco", "fortinet"]).optional(),
  ...
  bandwidthGbps: z.number().nonnegative().optional(),
  isGreenfield: z.boolean().optional(),
  hasOT: z.boolean().optional(), hasHPC: z.boolean().optional(),
  hasGPON: z.boolean().optional(), hasWireless: z.boolean().optional(),
  hasVoice: z.boolean().optional(), hasDC: z.boolean().optional(),
