...
/**
 * The five approved Cisco collaboration / Room Kit EQX SKUs and their scoped
...
/**
 * Fresh-copy map (keyed by SKU) of same-SKU recognition rows for the five approved
