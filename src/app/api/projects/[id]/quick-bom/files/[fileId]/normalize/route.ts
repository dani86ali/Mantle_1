/**
 * POST /api/projects/[id]/quick-bom/files/[fileId]/normalize - normalize an
 * already-recorded Quick BoM BoQ file into a normalized_boq artifact.
 *
 ...
 * server primitives, requireAuth, and the normalization wrapper service (no DB,
 * raw BoQ loader/parser, artifact/approval/evidence store, pricing, config
...
export async function POST(
  ...
  try {
    ...
    return NextResponse.json(
      {
        code: "quick_bom_boq_normalization_failed",
        error: "Unable to normalize Quick BoM BoQ file.",
      },
      { status: 500 }
    );
  }
