...
| 9 | Daily target: minimum 5 full submissions per day | — | Our throughput target |
| 10 | Follow-ups (pending clarifications, distributor responses, tracking sheet) | — | Phase 3: dashboard + notifications |
...
10. **The "minimum 5 submissions/day" target** means our agent needs to reliably produce BoMs in minutes, not hours.
